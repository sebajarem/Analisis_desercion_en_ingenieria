---
title: "Analisis de Variables predictoras"
# params: 
#   output_dir: "../../reports/"
#params:
#  encoding: "latin1"
...
```{r}
rf_rfe = read_rds(path = paste0(path_base, config$outputs,"rf_rfe_modelo_seleccion_variables.rds"))
...
El mejor resultado se consigue con modelos que tienen las 10 variables mencionadas anteiormente y en el grafico puede verse la evolución de dich métrica en función de la cantidad de varables que usa con su dispersión según todos los modelos generados con esa combinación.
...
```{r influencia_de_variables}

ggplot(data = rf_rfe_var10, aes(x = reorder(var, media_influencia), y = media_influencia)) +
  geom_line() +
  geom_col() +
  scale_x_discrete(breaks  = unique(rf_rfe_var10$var)) +
  geom_point() +
...
Existe una variable que claramente influye mucho mas en los resultados que los otros predictores.
