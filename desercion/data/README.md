Aquí almacenará sus archivos de datos sin procesar, procesador y temporales. 
Los archivos de la carpeta AUTO, Si están codificados en un formato de archivo compatible, se cargarán automáticamente cuando llame a `load.project ()`.
