...
ArchivoDeSalida = "modelgrid_svm_todasVariables_sinCicloLectivoCursada_datos06.txt"
ArchivoDeSalidaRDS = "modelgrid_svm_todasVariables_sinCicloLectivoCursada_datos06.rds"
